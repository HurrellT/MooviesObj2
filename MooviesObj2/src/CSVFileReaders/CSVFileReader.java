...
/**
* It reads a CSV File and returns an object from each line read. 
* It is up to the subclasses to define how that object gets created.
*/
...
public abstract class CSVFileReader<T> {
    ...
    **/
    public List<T> readFile(){
        ...
        return lines.map(line -> this.parseLine(this.splitLine(line)))
