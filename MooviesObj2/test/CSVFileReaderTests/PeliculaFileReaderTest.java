...
public class PeliculaFileReaderTest {
    ...
    public void setUp(){
        ...
        reader = new PeliculaFileReader("/home/tomas/Escritorio/Objetos 2/Trabajos Obj2/Archivos para FileReader/u.item.new.csv"); //el parametro de UsuarioFileReader es el string con la ubicacion del archivo
    }
